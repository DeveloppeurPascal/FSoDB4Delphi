# Database-based file system (FSoDB)

[Cette page en français.](LISEZMOI.md)

A (synchronized) file system over a database for Delphi projects.
...
To download this code repository, we recommend using "git", but you can also download a ZIP file directly from [its GitHub repository](https://github.com/DeveloppeurPascal/FSoDB4Delphi).
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/FSoDB4Delphi) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://fsodb.developpeur-pascal.fr/) or [the project devlog](https://developpeur-pascal.fr/fsodb-delphi.html).
...
If you detect any anomalies on earlier versions, please don't hesitate to [report them](https://github.com/DeveloppeurPascal/FSoDB4Delphi/issues) so that I can test and try to correct or provide a workaround.
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://fsodb.developpeur-pascal.fr/).
...
If you want an answer from the project owner the best way to ask for a new feature or report a bug is to go to [the GitHub repository](https://github.com/DeveloppeurPascal/FSoDB4Delphi) and [open a new issue](https://github.com/DeveloppeurPascal/FSoDB4Delphi/issues).
